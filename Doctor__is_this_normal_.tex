...
\title{Doctor, is this normal? \large \\ULAB, Division of Sincerely Serious Science\vspace{-0.5cm}}
\author{Mackaelan James Songco}
...
According to my sources, around May 2021 an image began circulating around the internet about a broken sidewalk. The image, which can be seen in \autoref{1}, claims that the sidewalk crack resembles the form of a normal distribution. This lab report will test that claim by fitting this curve with a normal standard distribution (also called a Gaussian distribution).
...
\section{Results}
After our data analysis, \autoref{2} reveals that a normal distribution fits our data well.
